...
--
-- Host: localhost    Database: aiep_comercio
-- ------------------------------------------------------
...
INSERT INTO `ci_sessions` VALUES ('1fe9c139e09bc97b815b3e12b8427fd3','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36',1382096199,''),('a6a60adf5dbee836ecf866b37e5450bf','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36',1382412723,'');
...
CREATE TABLE `detalle_pedido` (
  ...
  CONSTRAINT `detalle_pedido_ibfk_1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `pedido` (
  ...
  `ciudad_destino` int(2) NOT NULL,
  `fono_destino` int(20) NOT NULL,
...
-- Dump completed on 2013-10-22  1:16:20
